...
namespace _5thGradeV4
{
    public partial class fETC : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            label1.Text =
                "Сумма во всех СС считается одинаково. Мы начиная с единиц складываем все цифры и если их сумма превысила СС то мы количество поместившихся в этом избытке СС переносим в следующий разряд, а остаток пишем в итоговое число.";
